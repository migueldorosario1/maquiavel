...
export const UI: Record<Lang, Record<string, string>> = {
  ...
  pt: {
    ...
    // UI Visual Panel Strings
    panel_dossiers_title: 'Dossiês e linhas de pesquisa',
  ...
  es: {
    ...
    dossier_2_tag: 'Sur Global & geopolítica',
    dossier_2_title: 'La nueva arquitectura del sistema internacional',
    dossier_2_desc: 'Soberanía, alianzas emergentes y la voz del Sur Global en el debate contemporáneo.',
    dossier_3_tag: 'Tecnología & instituciones',
